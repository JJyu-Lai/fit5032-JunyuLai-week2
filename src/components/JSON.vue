  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 9: Render a list of Austen's works. 
        Hint: Use the v-for directive to iterate through
         the array of authors that you have filtered out. -->
    ...
    <section class="lab-section">
      ...
      <p>Store Types:</p>
      <!-- Activity 10: Iterate through the storeTypes array and 
        display the store type and the number of stores that use that type. -->
      <!-- TODO: CODE TO RENDER LIST OF STORE TYPES HERE -->
      <ul>
        <li v-for="(quantity, type) in bookstores.storeTypes" :key="type">
          {{ type }}:{{ quantity }}
        </li>
      </ul>
      ...
      <p>Opening Hours:</p>
      <!-- Activity 11: Iterate through the openingHours object and display 
        the day of the week and the opening and closing times. -->
      <!-- TODO: CODE TO RENDER LIST OF OPENING HOURS HERE -->
      <ul>
        <li v-for="(time, day) in bookstores.openingHours" :key="day">
          {{ day }}: Open from {{ time.open }} to {{ time.close }}
        </li>
      </ul>
